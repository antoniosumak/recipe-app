...
const stepsMock = [
  ...
  },
  {
    ...
    stepSix: 'Step 6',
    stepSixDesc:
      'Once cooked, set aside 1 cup of pasta water then drain the pasta.  Slowly whisk the pasta water into the egg mixture until the sauce loosens. ',
    stepSeven: 'Step 7',
    stepSevenDesc:
      'In the same skillet combine the pasta and rendered fat over low heat. Add in the pancetta, then pour the egg mixture into the pan and keep the heat on low. Lightly toss the pasta. Season with Freshly Ground Black Pepper (to taste), garnish with Parmesan, and serve hot! ',
  },
];
